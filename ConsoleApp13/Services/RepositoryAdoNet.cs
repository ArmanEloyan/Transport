...
//                                                  w.Id AS WayId,
//                                                  cf.Name AS CityFromName,
//                                                  cf.Id AS CitoFromId,
//                                                  ct.Name AS CityToName,
//                                                  ct.Id AS CitoToId,
//                                                  w.StartPrice
//                                                  FROM dbo.Way w
//                                                  INNER JOIN dbo.City cf ON w.CityFromId = cf.Id
//                                                  INNER JOIN dbo.City ct ON w.CityToId = ct.Id";
...
//                                cityFrom.Id = int.Parse(reader["CitoFromId"].ToString());
//                                cityFrom.Name = reader["CityFromName"].ToString();
//                                cityTo.Id = int.Parse(reader["CitoToId"].ToString());
//                                cityTo.Name = reader["CityFromName"].ToString();


//                                way.CityFrom = cityFrom;// GetCity(int.Parse(reader["CityFromId"].ToString()));
//                                way.CityTo = cityTo;//GetCity(int.Parse(reader["CityToId"].ToString()));
//                                way.StartPrice = double.Parse(reader["StartPrice"].ToString());
